...
const (
	...
	// RelationIDListWujiCacheKey 关系链ID列表在，在无极缓存配置中的key
	RelationIDListWujiCacheKey = "relation_id_cache"
	// WorksIDListWujiCacheKey 作品ID列表在，在无极缓存配置中的key
	WorksIDListWujiCacheKey = "works_id_cache"
)
