...
import (
	...
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/common/retry"
)

// AccessConfig timeline 接入配置
// http://wuji.oa.com/p/edit?appid=timeline_config&schemaid=access_config_test
...
// SceneConfig 场景配置表
// http://wuji.oa.com/p/edit?appid=timeline_config&schemaid=sence_config_test
...
// ReadConfig 读扩散配置
// http://wuji.oa.com/p/edit?appid=timeline_config&schemaid=read_config_test
