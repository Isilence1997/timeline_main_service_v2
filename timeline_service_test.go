...
//go:generate mockgen -destination=stub/git.code.oa.com/trpcprotocol/component_plat/video_timeline_timeline_rpc/timeline_service_mock.go -package=video_timeline_timeline_rpc -self_package=git.code.oa.com/trpcprotocol/component_plat/video_timeline_timeline_rpc git.code.oa.com/trpcprotocol/component_plat/video_timeline_timeline_rpc TimelineServiceClientProxy
...
func Test_TimelineService_GetTimelineList(t *testing.T) {
	...
	m.DoAndReturn(func(ctx context.Context, req interface{}, opts ...interface{}) (interface{}, error) {
		...
		err := timelineServiceService.GetTimelineList(trpc.BackgroundContext(), r, rsp)
		return rsp, err
	})
	...
	rsp, err := timelineServiceClientProxy.GetTimelineList(trpc.BackgroundContext(), req)
...
func Test_TimelineService_GetUnReadMark(t *testing.T) {
	...
	m.DoAndReturn(func(ctx context.Context, req interface{}, opts ...interface{}) (interface{}, error) {
		...
		err := timelineServiceService.GetUnReadMark(trpc.BackgroundContext(), r, rsp)
		return rsp, err
	})
	...
	rsp, err := timelineServiceClientProxy.GetUnReadMark(trpc.BackgroundContext(), req)
...
func Test_TimelineService_GetProfPicFeedData(t *testing.T) {
	...
	m.DoAndReturn(func(ctx context.Context, req interface{}, opts ...interface{}) (interface{}, error) {
		...
		err := timelineServiceService.GetProfPicFeedData(trpc.BackgroundContext(), r, rsp)
		return rsp, err
	})
	...
	rsp, err := timelineServiceClientProxy.GetProfPicFeedData(trpc.BackgroundContext(), req)
