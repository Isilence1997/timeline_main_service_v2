...
import (
	...
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/dao/redis"
...
func GetSortInfoMapAndBackSource(ctx context.Context, idList []string, scene, sourceKey string,
	...
	go sortInfoBackSource(trpc.CloneContext(ctx), idList, scene, sourceKey, sortInfoMap, cacheInfo)
