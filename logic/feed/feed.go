...
import (
	...
	videoTimeline "git.code.oa.com/trpcprotocol/component_plat/video_timeline_timeline_data"
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/common/constant"
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/common/utility"
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/dao/wuji"
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/logic/common"
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/logic/idlist"
	"git.code.oa.com/v/main_logic/feeds/trpc_timeline_main_service_v2/logic/sortcache"
...
func GetReadDiffusionFeed(ctx context.Context, entityID, pageContext string, sceneConfig *model.SceneConfig) (*model.
	...
	readConfig, err := wuji.GetReadConfig(ctx, readConfigID)
	if err != nil {
	...
	// 获取关系链列表
	relationIDCacheInfo := readConfig.CacheConfig[constant.RelationIDListWujiCacheKey]
	...
	// 获取作品列表
	worksIDCacheInfo := readConfig.CacheConfig[constant.WorksIDListWujiCacheKey]
